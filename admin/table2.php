...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>PT.YOT Nusantara - List test taker balpil</title>
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
                          ...
                          <?php
							...
							$sql = "select id,nama,emailhp,lang,jumlah,qid,stat from indomog";
							...
							while($row = mysql_fetch_array($result))
                              ...
                              <tr>
                                <td class="center"><?php echo $row['id'] ; ?></td>
                              	<td class="center"><?php echo $row['qid'] ; ?></td>
								<td class="center">
                                ...
                                <td class="center">
									<span class="data"><?php echo $row['jumlah'] ; ?></span>                                    
                                </td>
                                <td class="center">
									<span class="data"><?php echo $row['lang'] ; ?></span>                                    
                                </td>
								<td class="center">
