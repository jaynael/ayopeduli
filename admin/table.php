...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>ayopeduli.com | List Donasi ayopeduli.com</title>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="icon-user"></i><span class="break"></span>List Order Test Taker Balpil</h2>
						<div class="box-icon">
...
//require_once  "../wp-config.php";
							$sql = "select id,nama,emailhp,did,stat from donasi";
							...
							while($row = mysql_fetch_array($result))
                              ...
                              <tr>
                                <td class="center"><?php echo $row['id'] ; ?></td>
                              	<td class="center"><?php echo $row['did'] ; ?></td>
								<td class="center">
                                	<span class="data"><?php echo $row['nama'] ; ?></span>								
                                <td class="center">
									<span class="data"><?php echo $row['emailhp'] ; ?></span>                                    
                                </td>
								<td class="center">
									<span class="data"><?php echo $row['stat'] ; ?></span>                                   
                                </td>
								<!--<td class="center">									
