...
<!--
body {
	background-image: url("https://www.youngontop.com/addons/default/themes/yot/images/bg_body1.png");
...
?>
<div class="bar">&nbsp;</div>
<div class="logo" style="width:150px; margin:150px auto 0px;">
<img alt="logo" src="/addons/default/themes/yot/img/demo/logo-yot.png" width="150px"></a>
</div>
...
<?php 
	if($_SESSION['is_mobile']=="1"){
?>
            	window.location = 'http://mobile.youngontop.com/set_login.php?id=<?=$_SESSION['alt_user_id']?>&email=<?=$_SESSION['alt_email']?>&name=<?=$data['name']?>';
<?php
	}else{
?>
