...
Class Sangkur_m extends CI_Model{
	...
	public function daftar($nama, $email, $filename, $komunitas, $hp, $pesan){
		...
		if(count($em) !== 0 ){
			...
			if (count($uidsame)>0){
				$datas = (array(
					'error' => 'Mohon maaf email anda telah terdaftar dalam aksi ini Silahkan lakukan pembayaran Sebesar Rp.199.000 / Peserta ke BCA Acc. 1330-165-592 A.n Jaenul Khupron (Founder Ayopeduli.com) untuk mengikuti Event "Membangun Surga di Muara Gembong" ',		
				));
