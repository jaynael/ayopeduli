...
Class Savemugo_m extends CI_Model{
	...
	public function daftar($nama, $email, $filename, $komunitas, $hp, $pesan){
		...
		if(count($em) !== 0 ){
			...
			if (count($uidsame)>0){
				$datas = (array(
					'error' => 'Mohon maaf email anda telah terdaftar dalam aksi ini Silahkan lakukan pembayaran Sebesar Rp.30.000 ke BCA KCP Metro Pasar Baru a.n Yayasan Solidaritas Anak acc. 536-011-0399 untuk mengikuti sangkur #savemugo ',		
				));
													...
													<tr>
														<td valign='top'>
															...
															<table border='0' cellpadding='20' cellspacing='0' width='100%'>
																<tr>
																	<td valign='top' class='bodyContent'>
																		<div mc:edit='std_content00'>
																			...
																			Terima kasih telah bergabung dalam Sangkur (Sarang Kumpul Relawan) (<span style='font-style:italic;'>#SaveMUGO</span>) Berikut ini adalah rincian pembayaran untuk mengikuti event ini:
																		</div>
																	</td>
																</tr>
																<tr>
																	<td valign='top' style='padding-top:0; padding-bottom:0;'>
																	  ...
																	  <tr mc:repeatable>
																		...
																		<tr mc:repeatable>
																			  ...
																			  :</td>
																			  <td valign='top' class='dataTableContent' mc:edit='data_table_content01'>
																			<strong>1. BCA KCP Metro Pasar Baru <br>   a.n Yayasan Solidaritas Anak acc. 536-011-0399 dengan mencantumkan id donasi anda dalam referensi transfer donasi.</strong><br /><br />
                                                               Note : <br />
															 ...
															 Yayasan Solidaritas Anak adalah bagian dari ayopeduli.com dalam management donasi. 
																			  </td>                                                       
																		  </tr> 
			...
			$this->email->to($email);
			$this->email->cc('gufron@ayopeduli.com','bgreenattack@gmail.com');
			$this->email->subject('Pendaftaran sangkur #savemugo di ayopeduli.com');
