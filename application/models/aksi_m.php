...
//		return $query->result_array();
//		}	
		$query = $this->db->get_where('ap_aksi', array('aid' => $aid, 'uid' => $uid));		
		return $query->row_array();
...
//			return $query->result_array();
	...
	public function getcategory($cat = FALSE){
		...
		$this->db->join('ap_user', 'ap_user.uid = ap_aksi.uid');
	                                                    ...
	                                                    <tr>
	                                                        <td valign='top' class='bodyContent'>
	                                                            <div mc:edit='std_content00'>
	                                                                ...
	                                                                Selamat, Aksi anda ($namaaksi) Telah berhasil kami validasi, Mari sebarkan informasi aksimu ke rekan, saudara untuk mendapatkan lebih banyak lagi dukungan :
	                                                            </div>
															</td>
	                                                    </tr>
	                                                    <tr>
...
//		}
		...
		if (isset($judul2['judul'])){	
			...
			$this->load->view('footer');
			 ...
			 $sqlaksi   = "insert into ap_aksi (aid, uid, cat,  judul, descsing, donasi, jumlahtarget, tgl, vid, now, stat, deskripsi, pic, slug, verified, jumlahterkumpul) values ('$aid','$uid','$cat','$judul','$descsing','$donasi','$jumlahtarget','$tgl','$vid','$now1',1,'$desc','$picaksi','$slug',0,00)";
