        ...
        <div class="right" style="width:730px;">
            ...
            <div class="section" style="width: 580px;margin: 0px auto;">
                ...
                <div class="section">
                        ...
                        <div class="inp">
                        	<input type="text" placeholder="01/30/2014" name="tgl" class="datepicker input form-control required" value="<?php if (!isset($tgl)){
						 }else { echo $tgl ; } ?>">
                        </div>
