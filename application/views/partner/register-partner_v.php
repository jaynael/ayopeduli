...
<div id="login" class="partner">
	...
	margin: 0px 0px 1px -26px;" value="exclusive">Pilih Partner</a>
                          ...
                          <div class="form-group">
	                        <label for="exampleInputEmail1">Nama PIC (Nama) :</label>
	                        <div class="inp">
                      ...
                      <div class="panel panel-default">
                        ...
                        <div id="collapseThree" class="panel-collapse collapse">
                          <div class="panel-body">
                            ...
                            <li>3. Apabila anda sudah mempunyai voucher campaign silahkan kirimkan ke alamat ayopeduli.com, Jln Cut Mutiah Blok D. No.5 Rt.8/8 Kel.Margahayu Bekasi 17113</li>
                            <li>4. Jika anda belum memiliki voucher maka voucher tersebut akan di desain oleh tim ayopeduli.com </li>
                            <li>5. Selesai, campaign anda akan di approve oleh ayopeduli.com dan kami segera promosikan untuk para volunteer menukarkan Gudness Poin mereka dengan voucher anda melalui campaign</li>
                            </ul>
