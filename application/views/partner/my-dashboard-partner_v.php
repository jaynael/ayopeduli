<div id="content" class="page">
	<div class="wrapper">
        ...
        <div class="right" style="width:730px;">
            <div class="nav-dash">
            	<a href="http://ayopeduli.dev/partner/home" class="btn btn-primary"> My Promo</a>
                <a href="http://ayopeduli.dev/partner/new_promo" class="btn "> + Create Promo</a>
            ...
            <?php if (count($promo_item) > 0) {?>
            	...
            	<div class="item-aksi" id="item">
                    <div class="image">
                        <a href="/aksi/view/tetstst"><img src="/upload/partner/promo/<?php echo $promo_item[$i]['pic'] ?>"></a>
                    </div>
                    <div class="title">
                        <a href="/aksi/view/tetstst"><h2><?php echo $promo_item[$i]['judul'] ?></h2></a></div>
                    <div class="desc">
                        <div class="desc-top">
