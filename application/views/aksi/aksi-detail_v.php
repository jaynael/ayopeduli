					...
					<div class="form-group">
                            ...
                            <div class="col-sm-10">                              
                              <div class="input-prepend input-append">
                              		<div class="inp">
									<span class="add-on">Rp</span><input id="appendedPrependedInput" class="donasi_aksi required" name="donasi_aksi" size="16" type="text" onkeyup="var n=<?php echo $aksi_item['kode'] ?>;document.getElementById('totaldon').value= Number(document.getElementById('appendedPrependedInput').value)+Number(n.toFixed(0));">
                                    </div>
								</div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                 <div class="radio">
                                  <label>
                                    <input type="radio" name="donasi_ap" class="donasi_ap" value="0" onclick="var n=<?php echo $aksi_item['kode'] ?>;document.getElementById('totaldon').value= Number(document.getElementById('appendedPrependedInput').value)+Number(n.toFixed(0));">
                                    <span>Saya hanya akan donasi untuk Aksi ini</span>
                                  </label>
                                </div>
                                <div class="radio">
                                  <label>
                                    <input type="radio" name="donasi_ap" class="donasi_ap" value="1" onclick="var n=<?php echo $aksi_item['kode'] ?>;document.getElementById('totaldon').value=(0.1*document.getElementById('appendedPrependedInput').value)+ Number(document.getElementById('appendedPrependedInput').value)+Number(n.toFixed(0));">
