...
class Partner extends CI_Controller{
	...
	public function home(){
	   ...
	   {
		 $session_data = $this->session->userdata('logged_partner');
		...
		$this->load->view('partner/my-dashboard-partner_v');
		$this->load->view('partner/footer');
		}else{
				$data= array(
	  ...
	  // $type = $this->input->post('type');
	   ...
	   $config['upload_path'] = './upload/partner/';
		...
		else
		{
		    ...
		    $this->load->model('partner_m','',TRUE);
	   		$result = $this->partner_m->register($owner, $perusahaan, $bidang, $emailin, $handphone, $password,$filename);
	  ...
	  public function logout()
		 {
			 session_start();
			$this->load->helper(array('form', 'url'));
		   $this->session->unset_userdata('logged_partner');
		   session_destroy();
