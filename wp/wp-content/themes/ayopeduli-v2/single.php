    ...
    the_post(); ?>
            <div id="single">                       
                            ...
                            <div class="image">
                             <?php 				
									if(has_post_thumbnail()) { ?>
										<a href="<?php the_permalink(); ?>" > <? the_post_thumbnail('post-single');?></a>
									<? } else { ?>
                ...
                <div class="left">
                    ...
                    <div class="widget-popular donasi">
                    <?php if (in_category( array( 'sobat', 'yayasan', 'program' ) )) { ?>	
                            ...
                            <div class="widget-content">
                                ...
                                <div class="field-donate">
                                        <a class="btn btn-primary" data-toggle="modal" id="tab-donasi">Donasi Sekarang</a>
							...
							<a class="title" href="<?php echo esc_url( home_url( '/' ) ); echo 'author/' . get_the_author() . "\n";?>"><?php echo get_the_author(); ?> </a>
                        	...
                        	<div class="image">
								...
								?>   
                                 ...
                                 <p><?php
								  ...
								  get_the_author_meta( 'anggota', $userID ); ?>  </p>                        	
