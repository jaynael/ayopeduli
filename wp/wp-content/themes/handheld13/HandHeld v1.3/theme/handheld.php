...
Plugin Name:  HandHeld (shared on wplocker.com)
...
class Et_Mobile {
	...
	function save_options(){
		if ( isset( $_REQUEST['submit'] ) ){
			...
			echo '<div id="message" class="updated fade"><p><strong>' . __('Settings saved. W P L O C K E R. C O M','et_mobile') . '</strong></p></div>';
		}
	}
