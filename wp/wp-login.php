...
<body class="login">
<?php   if ( !is_multisite() ) { ?>
<div id="login"><h1><a href="<?php echo esc_url( apply_filters('login_headerurl', ' http://ayopeduli.com') ); ?>" title="<?php echo esc_attr( apply_filters('login_headertitle', __( 'Powered by WordPress' ) ) ); ?>"><?php bloginfo('name'); ?></a></h1>
<?php   } else { ?>
...
function register_new_user( $user_login, $user_email ) {
	...
	if ( ! $user_id ) {
		$errors->add( 'registerfail', sprintf( __( '<strong>ERROR</strong>: Couldn&#8217;t register you... please contact the <a href="gufron@ayopeduli.com">gufron@ayopeduli.com</a> !' ), get_option( 'admin_email' ) ) );
		return $errors;
	}
...
default:
	...
	if ( isset( $_REQUEST['redirect_to'] ) ) {
		...
		$redirect_to = 'http://localhost/ayopeduli-wp/';
	}
...
<?php		exit;
		...
		if ( ( empty( $redirect_to ) || $redirect_to == '' || $redirect_to == 'http://localhost/ayopeduli-wp/' ) ) {
