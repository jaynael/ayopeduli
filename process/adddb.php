...
{
	//mysql_query("INSERT INTO indomog values('$_POST[]')");
}
//get previous form details
$EmailHP = $_POST['EmailHP'];
$hp = $_POST['hp'];
$Name = $_POST['Name'];
$RMID = "1306407541";
$qid = autonumber("indomog","qid",4,"YOT");
$RC = $_POST['RC'];
$Alg = "yot";
$AlgID = "$EmailHP";
$IPD = $_POST['IPD'];
...
$QUrlBackground = $_POST['QUrlBackground'];
$QUrlImage = $_POST['QUrlImage'];
$QUrlLogo = $_POST['QUrlLogo'];
$su = "&qid=".$qid;
$QUrlSuccess= "http://youngontop.com/balpil/Balpil-success.php?emailhp=".$AlgID.$su;
//$QUrlSuccess= "http://dev.youngontop.com/balpil-live/Balpil-test.php?emailhp=".$AlgID;
$QUrlPending = $_POST['QUrlPending'];
$QUrlCancel = $_POST['QUrlCancel'];
$PurchaseAmt = $_POST['PurchaseAmt'];
$PurchaseDesc = "Pembayaran Tes Keseimbangan Pribadi (TKP) kode $qid";
$BMod = $_POST['BMod'];
$pass = "pOyNeinswa61hv";
}else{
