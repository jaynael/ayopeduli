...
<html>
	<head>
        ...
        <link rel="shortcut icon" href="http://ayopeduli.com/wp-contentuploads/2013/08/Icon-150x150.png"/>
		...
		<!-- Portfolio -->
			<article class="container box style2">
				<header>
                    ...
                    <span>Di</span><br>
                    <span>Kafe AliBaba, Pekayon - Minggu 2 Februari 2014 Pkl 10.00 wib</span><br>
                ...
                <header>
                    ...
                    <!--<ul class="relawan">
                     <?php // for ($i=0;$i<count($volunteer);$i++){ ?>
                    	<li style="">
                        	<div class="image">
                            	<img src="http://ayopeduli.comupload/user/53ba7040c166c4e1386a25eae8790990.jpg">
                            </div>
