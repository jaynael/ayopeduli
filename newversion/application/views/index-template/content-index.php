                ...
                <div class="desc">
                    <div class="desc-top">
                    	<?php 
                         ...
                         $donasi = $aksi_kesehatan['donasi'];
						?>
                        <?php 
                            $date = strtotime($aksi_kesehatan['tgl']);
                            $remaining = $date - time();                            
                            $days_remaining = floor($remaining / 86400);
                            $day_end = $aksi_kesehatan['tgl'];
                            $day_mulai = $aksi_kesehatan['now'];                             
                            $day_awal = strtotime($aksi_kesehatan['now']);
...
//								}
                    ...
                    <a href="/aksi/view/<?php echo $aksi_kesehatan['slug'] ?>/#donasi"><h4><?php echo $days_remaining ?> Hari lagi Aksi Berakhir</h4></a>
                    </div>
                    <div class="desc-bottom">
        ...
        <div class="category">
            ...
            <div class="item-aksi">
               ...
               <div class="desc">
                    <div class="desc-top">
                        <?php 
                         $target_k = $aksi_pendidikan['jumlahtarget'];
                         $terkumpul_k = $aksi_pendidikan['jumlahterkumpul'];
                         $progress_k = $terkumpul_k/$target_k * '100';
                         $selesai = $aksi_pendidikan['tgl'];
                         $donasi = $aksi_pendidikan['donasi'];
                        ?>
                        <?php 
                            $date = strtotime($aksi_pendidikan['tgl']);
                            $remaining = $date - time();                            
                            $days_remaining = floor($remaining / 86400);
                            $day_end = $aksi_pendidikan['tgl'];
                            $day_mulai = $aksi_pendidikan['now'];                             
                            $day_awal = strtotime($aksi_pendidikan['now']);
                            $remaining_awal =  $date - $day_awal ;
                            $day_awal_remaining = floor($remaining_awal/86400);
                            $progress_day = $days_remaining/$day_awal_remaining * '100';
                        ?>
...
//                              }
                    ...
                    <div class="desc-bottom">
						...
						$days_remaining = floor($remaining / 86400);
					?>
                    <a href="/aksi/view/<?php echo $aksi_pendidikan['slug']?>/#donasi"><h4><?php echo $days_remaining ?> Hari lagi Aksi Berakhir</h4></a>
                    </div>
                    <div class="desc-bottom">
        ...
        <div class="category">
            ...
            <div class="item-aksi">
                ...
                <div class="desc">
                    <div class="desc-top">
                        <?php 
                         $target_k = $aksi_lingkungan['jumlahtarget'];
                         $terkumpul_k = $aksi_lingkungan['jumlahterkumpul'];
                         $progress_k = $terkumpul_k/$target_k * '100';
                         $selesai = $aksi_lingkungan['tgl'];
                         $donasi = $aksi_lingkungan['donasi'];
                        ?>
                        <?php 
                            $date = strtotime($aksi_lingkungan['tgl']);
                            $remaining = $date - time();                            
                            $days_remaining = floor($remaining / 86400);
                            $day_end = $aksi_lingkungan['tgl'];
                            $day_mulai = $aksi_lingkungan['now'];                             
                            $day_awal = strtotime($aksi_lingkungan['now']);
                            $remaining_awal =  $date - $day_awal ;
                            $day_awal_remaining = floor($remaining_awal/86400);
                            $progress_day = $days_remaining/$day_awal_remaining * '100';
                        ?>
...
//                              }
                    ...
                    <div class="desc-bottom">
						...
						$days_remaining = floor($remaining / 86400);
					?>
                    <a href="/aksi/view/<?php echo $aksi_lingkungan['slug']?>/#donasi"><h4><?php echo $days_remaining ?> Hari lagi Aksi Berakhir</h4></a>
                    </div>
                    <div class="desc-bottom">
        ...
        <div class="clearfix"></div>        
        <div class="index volunteer" id="redeem">
            <h2>Gudness Partner</h2>
            <div class="item-volunteer redeem">
                <div class="pic">
                    <a href="#"></a><img src="upload/product/0f20be23a0f38eb9047bb40940c121fa.png" />
                </div>
            </div><!--end .item-volunteer-->
            <div class="item-volunteer redeem">
                <div class="pic">
                    <a href="#"></a><img src="upload/product/bc20831282012ea320ac3d2c98609bc8.png" />
                </div>
            </div><!--end .item-volunteer-->
            <div class="item-volunteer redeem">
                <div class="pic">
