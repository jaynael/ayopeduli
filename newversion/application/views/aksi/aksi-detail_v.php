                ...
                <?php } else { ?>
                  <div class="infodon alert alert-success">
                    ...
                    <p>2. Donasi langsung , Sertakan angka <?php echo $aksi_item['kode'] ?> dalam donasi anda ex. Rp.50.000 menjadi Rp.50.<?php echo $aksi_item['kode'] ?> sebagai penanda donasi anda ke rekening : <br>
                     BCA KCP Metro Pasar Baru <br> 
                     acc. 536-011-0399<br>a.n Yayasan Solidaritas Anak Terlantar <br>
					...
					<div class="form-group">
                            ...
                            <div class="col-sm-10">
                              <div class="input-prepend input-append">
                              		<div class="inp">
									<span class="add-on">Rp</span><input id="appendedPrependedInput" class="donasi_aksi required" name="donasi_aksi" size="16" type="text" onclick="var n=Math.random()*1000;document.getElementById('totaldon').value= Number(document.getElementById('appendedPrependedInput').value)+Number(n.toFixed(0));" onchange="var n=Math.random()*1000;document.getElementById('totaldon').value= Number(document.getElementById('appendedPrependedInput').value)+Number(n.toFixed(0));">
                                    </div>                                    
								</div>                               
                            </div>
...
//								});
              ...
              <div class="tab-pane active" id="diskusi">
                    <div  style="margin:10px 0px">
                        ...
                        <fb:comments href="http://ayopeduli.com/aksi/view/<?php echo $aksi_item['slug'] ?>" width="600px" numposts="20" colorscheme="light"></fb:comments>
                    </div>
                </div>
            </div>
