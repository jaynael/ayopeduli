...
Class Partner_m extends CI_Model{
	...
	public function register($owner, $perusahaan, $bidang, $type, $email1, $handphone, $password, $filename ){
   ...
   $this->load->library('email');
	                                                ...
	                                                <table border='0' cellpadding='20' cellspacing='0' width='100%'>
                                                    	...
                                                    	<tr>
	                                                      <td valign='top' class='bodyContent'>
	                                                            ...
	                                                            Untuk mengaktifkan akun anda, silahkan lakukan transfer donasi anda sejumlah $harga ke rekening berikut :<br />
    ...
    $this->email->to($email1,'gufron@ayopeduli.com');
...
//End Register partner
	public function insertproduct($namapartner, $product, $poin, $tersedia, $desk, $filename){
	function autoproduct($tabel2, $kolom2, $lebar2=0, $awalan2='')
				{
					$query2="select $kolom2 from $tabel2 order by $kolom2 desc limit 1";
					$hasil2=mysql_query($query2);
					$jumlahrecord2 = mysql_num_rows($hasil2);
		...
		$productid = autoproduct("ap_product","productid",5,"POAP");
		$data = array(
			'productid' => $productid,
