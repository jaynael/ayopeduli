...
if(isset($_POST['submitted'])) {
	...
	$unixes = autonumber("donasi","did",5,"AP");
	if(!isset($hasError)) {
	...
	//if(!isset($hasError)) {
		$to = "$email";
		$subject = "[$unixes] Detail donasi anda $nama untuk $tujuan";
