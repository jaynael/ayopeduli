...
class Index extends CI_Controller{
	...
	public function index(){
		...
		//$this->load->view('mobilheader', $data);
		$this->load->model(array('aksi_m'));
		$data['aksi_slider'] = $this->aksi_m->aksi_home_slider();
		//aksi slider
		//aksi data
//		$data['judul'] = $data['aksi_slider']['judul'];
//		$data['aid'] = $data['aksi_slider']['aid'];		
//		$data['jumlahtarget'] = $data['aksi_slider']['jumlahtarget'];
//		$data['jumlahterkumpul'] = $data['aksi_slider']['jumlahterkumpul'];
//		$data['slug'] = $data['aksi_slider']['slug'];
//		$data['pic'] = $data['aksi_slider']['pic'];		
		//fasilitator data
		//$data['uid'] = $data['aksi_lingkungan']['uid'];		
		//$uid = $data['aksi_slider']['uid'];	
...
//		$data['poin'] = $data['aksi_user_lingkungan']['poin'];
		...
		$data['aksi_user_lingkungan'] = $this->aksi_m->getuser($uid);
		$data['fullname'] = $data['aksi_user_lingkungan']['fullname'];
		$data['uid'] = $data['aksi_user_lingkungan']['uid'];
		$data['photo'] = $data['aksi_user_lingkungan']['photo'];
		$data['poin'] = $data['aksi_user_lingkungan']['poin'];	
		...
		$data['uid'] = $data['aksi_user_kesehatan']['uid'];
		...
		$data['uid'] = $data['aksi_user_pendidikan']['uid'];
