            ...
            <div class="item-aksi" style="width: 750px;float: none;margin: 0px auto 20px;padding: 20px;height: auto;overflow:inherit;">            
				...
				<h2 class="regis">Gabung Menjadi Gudness Partner ayopeduli.com</h2>
                	<?php echo validation_errors(); ?>
   						<?php echo form_open_multipart('partner/register'); ?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="plans">
	                        <div class="plan">
						      ...
						      <p class="plan-price">Rp.500.000 <span class="plan-unit">Donasi per tahun</span></p>
						      ...
						      <a class="plan-button"><input type="radio" name="type" style="width: 34px !important;
margin: 0px 0px 1px -26px;" value="regular">Pilih Partner</a>
						    ...
						    <div class="plan plan-highlight">
						      ...
						      <p class="plan-price">Rp.2.500.000 <span class="plan-unit">Donasi per tahun</span></p>
						      <ul class="plan-features">
...
margin: 0px 0px 1px -26px;" value="regular">Pilih Partner</a>
						    ...
						    <div class="plan">
						      ...
						      <p class="plan-price">Rp.10.000.000 <span class="plan-unit">per tahun</span></p>
						      <ul class="plan-features">
						        <li class="plan-feature">950 <span class="plan-feature-name">Gudness Voucher</span></li>
